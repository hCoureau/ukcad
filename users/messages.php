...
<div class="btn-group pull-left"><button type="button" class="btn btn-info" data-toggle="modal" data-target="#composemass"><i class="fa fa-plus"></i> <?=lang("MSG_NEW_MASS");?></button>
</div>
<?php } ?> <center><?=lang("MSG_CONV");?> <a href="#" data-toggle="modal" class="nounderline" data-target="#settings"><i class="fa fa-cog"></i></a>
